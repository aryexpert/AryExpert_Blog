      ...
      {currentUser ? (
        <div className="flex items-center gap-1 my-5 text-gray-500 text-sm">
          ...
          <Link
            ...
            className="text-xm text-cyan-600 hover:hunderline"
          >
        ...
        <div className="text-sm text-teal-500 my-5 flex gap-1">
          Vous devez être connecté afin de laisser un commentaire.
      ...
      {comments.length === 0 ? (
        ...
        <>
          <div className="text-sm my-5 flex items-center gap-1">
            {comments.length > 1 ? <p>Commentaires</p> : <p>Commentaire</p>}
