  ...
  return (
    <div className="p-3 md:mx-auto">
      <div className="flex-wrap flex gap-4 justify-center">
        <div className="flex flex-col p-3 dark:bg-slate-800 gap-4 md:w-72 w-full rounded-md shadow-md">
          <div className="flex justify-between">
            <div className="">
              <h3 className="text-gray-500 text-md uppercase">Total Utilisateurs</h3>
      ...
      <div className="flex flex-wrap gap-4 py-3 mx-auto justify-center">
        ...
        >
          <div className="flex justify-between p-3 text-sm font-semibold">
            ...
            <Button outline gradientDuoTone="purpleToPink">
              <Link to={"/dashboard?tab=users"}>Tout consulter</Link>
            </Button>
          </div>
          <Table hoverable>
            <Table.Head>
              <Table.HeadCell>Image Utilisateure</Table.HeadCell>
              <Table.HeadCell>Nom Uilisateur</Table.HeadCell>
            </Table.Head>
            {users &&
              users.map((user) => (
        ...
        >
          <div className="flex justify-between p-3 text-sm font-semibold">
            <h1 className="text-center p-2">Commentaires récent</h1>
            <Button outline gradientDuoTone="purpleToPink">
              <Link to={"/dashboard?tab=comments"}>Tout consulter</Link>
            </Button>
          </div>
          <Table hoverable>
            <Table.Head>
              <Table.HeadCell>Contenu De Commentaire</Table.HeadCell>
        ...
        >
          <div className="flex justify-between p-3 text-sm font-semibold">
            ...
            <Button outline gradientDuoTone="purpleToPink">
              <Link to={"/dashboard?tab=posts"}>Tout consulter</Link>
            </Button>
          </div>
          <Table hoverable>
            <Table.Head>
