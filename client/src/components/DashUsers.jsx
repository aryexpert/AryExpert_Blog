  ...
  return (
    ...
    >
      {currentUser.isAdmin && users.length > 0 ? (
        <>
          <Table hoverable className="shadow-md">
            <Table.Head>
              ...
              <Table.HeadCell>Image Utilisateur</Table.HeadCell>
                ...
                <Table.Row className="bg-white dark:border-gray-700 dark:bg-gray-800">
                  ...
                  <Table.Cell>
                      <img
                        ...
                        alt={user.username}
                        className="w-10 h-10 object-cover bg-gray-500 rounded-full shadow-md"
                      />
                  </Table.Cell>
                  <Table.Cell>
                      {user.username}
        ...
        <p>Vous n'avez aucun utilisateur en ce moment !</p>
      )}
        ...
        <Modal.Body>
          <div className="text-center">
            ...
            <h3 className="mb-5 text-lg text-gray-500 dark:text-gray-400">
              Êtes-vous sûr de vouloir supprimer cet utilisateur? Cette action sera définitive !
            </h3>
